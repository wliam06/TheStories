//
//  CollectionMasonaryLayout.swift
//  TheStories
//
//  Created by Wil Liam on 6/30/19.
...
public class CollectionMasonary: UICollectionViewLayout {
    ...
    override public class var layoutAttributesClass: AnyClass {
        return CollectionLayoutAttribute.self
    }
        ...
        if cache.isEmpty {
            ...
            for section in 0..<numberOfSections {
                ...
                if let headerSize = delegate.collectionView?(
                    ...
                    let headerAttributes = CollectionLayoutAttribute(
                ...
                if let footerSize = delegate.collectionView?(
                    ...
                    let footerAttributes = CollectionLayoutAttribute(
